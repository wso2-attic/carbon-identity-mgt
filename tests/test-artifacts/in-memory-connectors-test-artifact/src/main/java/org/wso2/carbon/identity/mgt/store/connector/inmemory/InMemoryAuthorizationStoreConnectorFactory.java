...
/**
 * In memory authorization connector factory for tests
 */
public class InMemoryAuthorizationStoreConnectorFactory implements AuthorizationStoreConnectorFactory {
    @Override
    public AuthorizationStoreConnector getInstance() {
        return new InMemoryAuthorizationStoreConnector();
    }
}
