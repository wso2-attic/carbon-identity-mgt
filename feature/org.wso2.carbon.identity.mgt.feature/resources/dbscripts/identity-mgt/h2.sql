...
CREATE UNIQUE INDEX IDM_ENTITY_INDEX_1
  ON IDM_USER (USER_UUID, DOMAIN, CONNECTOR_TYPE, CONNECTOR_ID, CONNECTOR_USER_ID);

CREATE INDEX IDM_ENTITY_INDEX_2 ON IDM_USER (CONNECTOR_ID, CONNECTOR_USER_ID);

CREATE INDEX IDM_ENTITY_INDEX_3 ON IDM_USER(USER_UUID);
