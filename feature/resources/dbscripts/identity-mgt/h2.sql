...
(
  ...
  CONNECTOR_ENTITY_ID VARCHAR(64)                        NOT NULL,
);

CREATE UNIQUE INDEX IDM_ENTITY_INDEX_1
  ON IDM_ENTITY (ENTITY_UUID, DOMAIN, CONNECTOR_TYPE, CONNECTOR_ID, CONNECTOR_ENTITY_ID);

CREATE INDEX IDM_ENTITY_INDEX_2 ON IDM_ENTITY (CONNECTOR_ID, CONNECTOR_ENTITY_ID);
