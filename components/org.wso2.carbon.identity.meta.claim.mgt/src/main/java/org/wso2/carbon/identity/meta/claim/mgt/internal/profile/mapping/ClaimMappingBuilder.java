...
import org.wso2.carbon.identity.meta.claim.mgt.internal.claim.mapping.ClaimMappingFile;
...
public class ProfileMappingBuilder {
    ...
    private ProfileMappingBuilder profileConfig = null;
    ...
    private ProfileMappingBuilder() throws ClaimMappingBuilderException {
        ...
        applicationMappings = profileConfig.getApplicationClaimMapping().stream().filter(Objects::nonNull)
