...
////
////            if (resultSet.next()) {
////                UserRecoveryData userRecoveryData = new UserRecoveryData(user, code, recoveryScenario,
// recoveryStep);
...
////                        .ConnectorConfig.EXPIRY_TIME, user.getTenantDomain()));
// Notification expiry time in minutes
