...
////                                             .updateUserCredentials(userRecoveryData.getUser().getUniqueUserId(),
//    // null);
...
// NOTIFICATION_SEND_RECOVERY_NOTIFICATION_SUCCESS));
//////
//////
...
////                if (StringUtils.isNotBlank(metaProperty.getValue()) &&
// StringUtils.isNotBlank(metaProperty.getKey()))
//    // {
