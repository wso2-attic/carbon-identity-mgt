...
//                                              new IdentityRecoveryException("InitiateUserChallengeQuestion :
// Identity" +
...
//        if (StringUtils.isBlank(user.getDomainName())) {
//            throw Utils.handleServerException(IdentityRecoveryConstants.ErrorMessages.ERROR_CODE_UNEXPECTED, null,
//                                              new IdentityRecoveryException("Init
// iateUserChallengeQuestion : Identity" +
//                                                                            " store domain is not in the request"));
//        }
//
////        boolean isRecoveryEnable = Boolean.parseBoolean(
...
////            if (!isRecoveryEnable) {
////                throw Utils.handleClientException(
////                        IdentityRecoveryConstants.ErrorMessages.ERROR_CODE_QUESTION_BASED_RECOVERY_NOT_ENABLE,
// null);
...
//            }
//
//            String challengeQuestionSeparator = IdentityRecoveryConstants.ConnectorConfig.
// QUESTION_CHALLENGE_SEPARATOR;
