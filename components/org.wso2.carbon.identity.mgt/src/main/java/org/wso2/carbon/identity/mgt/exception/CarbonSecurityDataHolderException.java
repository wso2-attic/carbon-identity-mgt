...
public class CarbonSecurityDataHolderException extends Exception {
    ...
    public CarbonSecurityDataHolderException() {
        super();
    }

    public CarbonSecurityDataHolderException(String message) {
        super(message);
    }

    public CarbonSecurityDataHolderException(String message, Throwable cause) {
        super(message, cause);
    }
}
