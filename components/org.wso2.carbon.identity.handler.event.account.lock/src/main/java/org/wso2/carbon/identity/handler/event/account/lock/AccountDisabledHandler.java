...
public class AccountDisabledHandler extends AbstractEventHandler {
    ...
    private static List<String> events = Arrays.asList(
            ...
            StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USER_CLAIMS_PATCH,
            StoreConstants.IdentityStoreInterceptorConstants.POST_UPDATE_USER_CLAIMS_PATCH,
            StoreConstants.IdentityStoreInterceptorConstants.POST_UPDATE_USER_CLAIMS_PUT,
            StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USER_CREDENTIALS_PUT,
            StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USER_CREDENTIALS_PATCH,
            StoreConstants.IdentityStoreInterceptorConstants.PRE_DELETE_USER,
            StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_GROUPS_OF_USER_PUT,
            StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_GROUPS_OF_USER_PATCH,
            StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USERS_OF_GROUP_PUT,
            StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USERS_OF_GROUP_PATCH,
            StoreConstants.IdentityStoreInterceptorConstants.POST_AUTHENTICATE);
    @Override
    public void handle(EventContext eventContext, Event event) throws EventException {
        ...
        try {
            if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USER_CLAIMS_PUT
                    .equals(event.getEventName())) {
                handlePreUpdateUserClaimsPUT(eventContext, event, identityStore);

            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USER_CLAIMS_PATCH
                    .equals(event.getEventName())) {
                handlePreUpdateUserClaimsPATCH(eventContext, event, identityStore);

            } else if (event.getEventName().equals(StoreConstants.IdentityStoreInterceptorConstants
                    .POST_UPDATE_USER_CLAIMS_PATCH) ||
                    event.getEventName().equals(StoreConstants.IdentityStoreInterceptorConstants
                            .POST_UPDATE_USER_CLAIMS_PUT)) {
                //Post update user PUT and Post update user PATCH
                handlePostUpdateUserClaims(eventContext, event);
            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USER_CREDENTIALS_PUT
                    .equals(event.getEventName())) {
                handleDisableFromUniqueUserId(event, identityStore);

            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USER_CREDENTIALS_PATCH
                    .equals(event.getEventName())) {
                handleDisableFromUniqueUserId(event, identityStore);

            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_DELETE_USER
                    .equals(event.getEventName())) {
                handleDisableFromUniqueUserId(event, identityStore);

            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_GROUPS_OF_USER_PUT
                    .equals(event.getEventName())) {
                handleDisableFromUniqueUserId(event, identityStore);

            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_GROUPS_OF_USER_PATCH
                    .equals(event.getEventName())) {
                handleDisableFromUniqueUserId(event, identityStore);

            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USERS_OF_GROUP_PUT.equals(event
                    .getEventName())) {
                List<String> uniqueUserIds = (List<String>) event.getEventProperties().get(
                        StoreConstants.IdentityStoreConstants.UNIQUE_USED_ID_LIST);
            ...
            } else if (StoreConstants.IdentityStoreInterceptorConstants.PRE_UPDATE_USERS_OF_GROUP_PATCH
                    .equals(event.getEventName())) {
                List<String> uniqueUserIdsToAdd = (List<String>) event.getEventProperties().get(
                        StoreConstants.IdentityStoreConstants.UNIQUE_USED_ID_LIST_TO_ADD);
                ...
                List<String> uniqueUserIdsToRemove = (List<String>) event.getEventProperties().get(
                        StoreConstants.IdentityStoreConstants.UNIQUE_USED_ID_LIST_TO_REMOVE);
            ...
            } else if (StoreConstants.IdentityStoreInterceptorConstants.POST_AUTHENTICATE
                    .equals(event.getEventName())) {
    ...
    private void handleDisableFromUniqueUserId(Event event, IdentityStore identityStore)
        ...
        String userId = (String) event.getEventProperties().get(
